...
public class Card {
    ...
    public Card(String number, String expDate, String cvv) {
        this.number = number;
    ...
    private String getType(String number) {
        return CardType.toString(CardType.getType(number));
    }
...
//			adding last character
    ...
    public String cardCryptogram(String publicId) throws UnsupportedEncodingException,
            NoSuchPaddingException, NoSuchAlgorithmException, NoSuchProviderException, BadPaddingException,
